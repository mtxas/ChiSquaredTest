...
```
Hier erhalten wir einen Fehler 1. Art von rund 9 Prozent. Wir können fast sicher sein, dass die Variablen abhängig sind, doch nicht super, super sicher (wie bei Politik, siehe unten). 
...
Dies war ein Beispiel, wo man sogar vermutet, dass die Variablen vielleicht unabhängig sind.
